    ...
    def _do(self, problem, pop, *args, n_survive=None, ideal=None, nadir=None, random_state=None, **kwargs):
        ...
        for k, front in enumerate(fronts):
            ...
            if len(survivors) + len(front) > n_survive:
                ...
                front = front[subset]
                # print("Iteration: %d, Front size: %d, Selected subset size: %d" % (self.iter, len(F), len(subset)))
                self.iter += 1
...
class SMSEMOA_HSS_DEC(GeneticAlgorithm):
...
parse_doc_string(SMSEMOA_HSS_DEC.__init__)
